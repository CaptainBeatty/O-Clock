Voici ton TP mis en forme en **Markdown**, prêt à être publié sur GitHub.
Les images référencent le dossier `/captures`, comme tu l’as demandé.
...
Souhaites-tu que je t’ajoute un petit bloc d’introduction et une conclusion plus formelle pour que ça passe mieux sur GitHub (style rapport de TP complet) ?
```
